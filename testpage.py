...
class TestSearchLocators:
    ...
    LOCATOR_PASSWORD_FIEID = (By.XPATH, """//*[@id="login"]/div[2]/label/input""")
...
class OperationsHelper(BasePage):
    ...
    def enter_password(self, word):
        logging.info(f"Sent {word} to element {TestSearchLocators.LOCATOR_PASSWORD_FIEID[1]}")
        login_field = self.find_element(TestSearchLocators.LOCATOR_PASSWORD_FIEID)
        login_field.clear()
        login_field.send_keys(word)
